...
<head>
    ...
    <title>Empresa: Eliminar Producto</title>
...
<body>
    ...
    <form action="../Controlador/controla_EliminarProducto.php" method="post">
        <label for="codigo">Introduzca el código del producto:</label>
