...
<head>
    ...
    <title>Empresa: Filtro por descripción</title>
...
<body>
    ...
    <h2>Filtrar producto por Descripción</h2>

    <form action="../Controlador/controla_FiltroDescripcion.php" method="post">
        <label for="descripcion">Introduzca descripción del producto:</label>
